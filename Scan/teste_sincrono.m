...
%%winopen('Plataforma_de_testes_2.ttt');
...
Z1 = zeros((length(Pv)), 13);
Z2 = zeros((length(Pv)), 13);
...
for i=1:length(Pv)
        ...
        Z1(i,10) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S11, vrep.simx_opmode_buffer);
        Z1(i,11) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S12, vrep.simx_opmode_buffer);
        Z1(i,12) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S13, vrep.simx_opmode_buffer);
        Z1(i,13) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S14, vrep.simx_opmode_buffer);
        Z2(i,1) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S15, vrep.simx_opmode_buffer);
        Z2(i,2) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S16, vrep.simx_opmode_buffer);
        Z2(i,3) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S17, vrep.simx_opmode_buffer);
        Z2(i,4) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S18, vrep.simx_opmode_buffer);
        Z2(i,5) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S19, vrep.simx_opmode_buffer);
        Z2(i,6) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S20, vrep.simx_opmode_buffer);
        Z2(i,7) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S21, vrep.simx_opmode_buffer);
        Z2(i,8) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S22, vrep.simx_opmode_buffer);
        Z2(i,9) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S23, vrep.simx_opmode_buffer);
        Z2(i,10) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S24, vrep.simx_opmode_buffer);
        Z2(i,11) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S25, vrep.simx_opmode_buffer);
        Z2(i,12) = auxData(1,11);
        [retCod,detectionState,auxData,auxPacketInfo]=vrep.simxReadVisionSensor(clientID, S26, vrep.simx_opmode_buffer);
        Z2(i,13) = auxData(1,11);
