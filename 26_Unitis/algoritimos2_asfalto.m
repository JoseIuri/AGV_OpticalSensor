...
%      i1(c) = (I1(c,1)*(Z1mod(c,I1(c,1)))+I1(c,2)*(Z1mod(c,I1(c,2)))+I1(c,3)*(Z1mod(c,I1(c,3))))/((Z1mod(c,I1(c,1)) + (Z1mod(c,I1(c,2)))) + (Z1mod(c,I1(c,3))));
%      i2(c) = (I2(c,1)*(Z2mod(c,(I2(c,1)-13)))+I2(c,2)*(Z2mod(c,(I2(c,2)-13))) + I2(c,3)*(Z2mod(c,(I2(c,3)-13))))/((Z2mod(c,(I2(c,1)-13)) + (Z2mod(c,(I2(c,2)-13)))+ (Z2mod(c,(I2(c,3)-13)))));
    i1a(c) = I1(c,1);
    i2a(c) = I2(c,1);
end
